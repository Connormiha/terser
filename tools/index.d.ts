...
export interface CompressOptions {
    ...
    properties?: boolean;
    /**
     * An array of names and Terser will assume that those functions do not produce side effects.
     * DANGER: will not check if the name is redefined in scope.
     * An example case here, for instance `var q = Math.floor(a/b)`.
     * If variable q is not used elsewhere, Terser will drop it, but will still keep the `Math.floor(a/b)`,
